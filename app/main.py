...
LEVEL_STYLE = {
    "A": "只描述行為、偏好或當下狀態，不需解釋原因、不牽涉性格或價值。回答不構成自我揭露，也不影響關係。",
    "B": "描述個人習慣、選擇傾向與生活取向，讓人看見輪廓，但不需揭露情緒或關係經驗。",
    "C": "涉及關係互動、情緒經驗或人生節奏，但問題本身不要求脆弱、不回溯創傷，回答可以停在「感覺描述」。",
    "D": "觸及脆弱、遺憾、界線或真實渴望，回答可能改變他人對自己的理解；必須明示可跳過、不追問、不要求細節。",
}
